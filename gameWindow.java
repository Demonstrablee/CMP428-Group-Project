...
import Levels.CardManagerPanel;
...
public class gameWindow extends JFrame{
        ...
        final static DisplayMode displayFullScreenModes [] = {
        ...
        static JPanel cardJPanel = new JPanel(new CardLayout());
    public static void main (String [] args){
        ...
        ///Levels or CANVAS's
        CardManagerPanel managerPanel = new CardManagerPanel(windowResolutions[currResMode][0],windowResolutions[currResMode][1]);
       
        

        window.setSize(windowResolutions[currResMode][0],windowResolutions[currResMode][1]);
        // attach canvas to frame
        window.setContentPane(managerPanel); // add the content pane to the jframe
